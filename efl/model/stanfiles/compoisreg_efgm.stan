...
model {
    ...
    // Model, goals follow COM-Poisson distribution with EFGM copula
    {
...
generated quantities {
    ...
    
    {
        ...
        // Generate predictive home/away scores for observed games
        for (i in 1:nGames) {
            int gp[2] = com_poisson_efgm_rng({lmu_home[i], lmu_away[i]}, nu, truncpoint, phi);
            homegoals_pred[i] = gp[1];
            awaygoals_pred[i] = gp[2];
        }
        // Generate predictive home/away scores for unobserved games
