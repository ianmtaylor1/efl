...
class ConsulJainRegEFGM(base.GoalModel):
    ...
    PoisRegSimple than PoisRegNumberphile). Uses an EFGM copula to correlate
    the home and away goals for each game.
    """
    
    def __init__(self, eflgames, prior=None, **kwargs):
        """Parameters:
            eflgames - a Games instance
            prior - instance of ConsulJainRegEFGM_Prior, or None for a diffuse 
                prior (default)
...
class ConsulJainRegEFGM_Prior(object):
    """A class holding a prior for the ConsulJainRegEFGM model."""
    ...
    def from_fit(cls, fit, spread=1.0, regression=1.0,
        ...
        """Create a prior from the posterior of a previous ConsulJainRegEFGM fit.
        Parameters:
            fit - the previous instance of ConsulJainRegEFGM
